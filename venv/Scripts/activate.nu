...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SummonFly\PycharmProjects\pythonApplication\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SummonFly\PycharmProjects\pythonApplication\venv\Scripts\deactivate.nu'
